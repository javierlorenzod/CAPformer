...
PIE_DATA= 	# e.g. /home/user/PIE/
JAAD_DATA=  # e.g. /home/user/JAAD/

# Provide full path to where the trained models would be stored.

MODELS=  # e.g. /home/user/CAPformer/models/

# Provide full path to CAPformer folder

CODE_FOLDER= # e.g. /home/user/CAPformer/

# Data folder containing features used for training (resize images, pose, etc)
FEATURE_FOLDER= # e.g. /home/user/CAPformer/data
###################################################################
...
IMAGE_NAME=jld/tensorflow/tensorflow # CHANGE with the name of your image used in build_docker.sh
TAG=latest-gpu-tfa
CONTAINER_NAME=tf2_run_with_tfa
...
docker run --rm -it --gpus "device=${GPU_DEVICE}"  \
	...
	--mount type=bind,source=${FEATURE_FOLDER},target=${CODE_FOLDER}/data/ \

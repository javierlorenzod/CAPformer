...
PIE_DATA=/media/14TBDISK/jlo23/datasets/PIE/ 	# e.g. /home/user/PIE/
JAAD_DATA=/media/14TBDISK/jlo23/datasets/jaad/JAAD/

# Provide full path to where the trained models would be stored.

MODELS=/media/14TBDISK/jlo23/models/ # e.g. /home/user/Ped_Cross_Benchmark/models/

# Provide full path to Ped_Cross_Benchmark folder

CODE_FOLDER=/home/jlo23/PedestrianActionBenchmark/ # e.g. /home/user/Ped_Cross_Benchmark/
...
IMAGE_NAME=jld/tensorflow/tensorflow 
TAG=latest-gpu-tfa
CONTAINER_NAME=tf2_run_jld_with_tfa
...
docker run --rm -it --gpus "device=${GPU_DEVICE}"  \
	...
	--mount type=bind,source=/media/14TBDISK/jlo23/data_for_python36/data,target=${CODE_FOLDER}/data/ \
